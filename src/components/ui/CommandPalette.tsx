...
const COMMANDS: ReadonlyArray<Command> = [
  ...
  { id: "onboarding", label: "Onboarding", href: "/onboarding", group: "Go to", keywords: "setup wizard", Icon: IconOnboarding },
  { id: "assessments", label: "Assessments", href: "/assessments", group: "Go to", keywords: "readiness score", Icon: IconAssessments },
  { id: "roadmaps", label: "Roadmaps", href: "/roadmaps", group: "Go to", keywords: "plan milestones", Icon: IconRoadmaps },
  { id: "programs", label: "Programs", href: "/programs", group: "Go to", keywords: "portfolio library gate", Icon: IconPrograms },
  { id: "tiers", label: "Tiers", href: "/tiers", group: "Go to", keywords: "partner tier select advanced premier", Icon: IconTiers },
  ...
  { id: "evidence", label: "Evidence Locker", href: "/evidence", group: "Go to", keywords: "documents files compliance", Icon: IconEvidence },
  { id: "reports", label: "Reports", href: "/reports", group: "Go to", keywords: "export snapshot", Icon: IconReports },
  { id: "tasks", label: "Tasks", href: "/tasks", group: "Go to", keywords: "todo work", Icon: IconTasks },
  ...
  { id: "new-assessment", label: "New assessment", href: "/assessments/new", group: "Create", keywords: "create readiness" },
  { id: "new-roadmap", label: "New roadmap", href: "/roadmaps/new", group: "Create", keywords: "create plan" },
  { id: "new-mdf", label: "New MDF request", href: "/mdf", group: "Create", keywords: "request funds" },
  { id: "new-task", label: "New task", href: "/tasks", group: "Create", keywords: "create todo" },
