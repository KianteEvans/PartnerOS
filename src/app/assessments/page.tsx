    ...
    <PageShell>
      ...
      <Panel actions={<SearchForm q={params.q} placeholder="Search by name…" hidden={{ sort: params.sort, dir: params.dir }} />}>
        ...
        <Pagination
          ...
          total={total}
          prevHref={listHref("/assessments", { q: params.q, sort: params.sort, dir: params.dir, page: params.page - 1 })}
          nextHref={listHref("/assessments", { q: params.q, sort: params.sort, dir: params.dir, page: params.page + 1 })}
        />
      </Panel>
    </PageShell>
  );
